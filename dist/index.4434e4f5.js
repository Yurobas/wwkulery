document.addEventListener("DOMContentLoaded", ()=>{
    (function headerSlider() {
        const imagesLinks = [
            ...document.querySelectorAll(".header__visual-slider-link")
        ];
        const tabsLinks = [
            ...document.querySelectorAll(".header__visual-tab-link")
        ];
        const tabs = [
            ...document.querySelectorAll(".header__visual-tab")
        ];
        const images = [
            ...document.querySelectorAll(".header__visual-image")
        ];
    ...
    (function yandexMapContacts() {
         ...
         */ ymaps.ready(function() {
            ...
            MyIconContentLayout = ymaps.templateLayoutFactory.createClass('<div style="color: #FFFFFF; font-weight: bold; border-color: 6px;">$[properties.iconContent]</div>'), //Добавляем маркеры офисов указывая их координаты
