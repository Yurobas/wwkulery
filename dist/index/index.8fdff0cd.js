   ...
   */ /* eslint-disable no-proto */ function makeReactive(obj) {
    ...
    function updateSlides() {
        ...
        if (!isVirtual && !params.cssMode && (params.effect === 'slide' || params.effect === 'fade')) {
            if (slidesLength <= params.maxBackfaceHiddenSlides) swiper.$el.addClass(`${params.containerModifierClass}backface-hidden`);
            else swiper.$el.removeClass(`${params.containerModifierClass}backface-hidden`);
        }
    }
